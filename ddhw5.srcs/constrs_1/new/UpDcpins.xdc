...
set_property -dict { PACKAGE_PIN V10 IOSTANDARD LVCMOS33 } [get_ports { CLK100MHZ }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
...
set_property -dict { PACKAGE_PIN T13 IOSTANDARD LVCMOS33 } [get_ports { ENP }]; #IO_L23P_T3_A03_D19_14 Sch=sw[11]
set_property -dict { PACKAGE_PIN H6 IOSTANDARD LVCMOS33 } [get_ports { ENT }]; #IO_L24P_T3_35 Sch=sw[12]
set_property -dict { PACKAGE_PIN U12 IOSTANDARD LVCMOS33 } [get_ports { UpD }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
...
set_property -dict { PACKAGE_PIN V17 IOSTANDARD LVCMOS33 } [get_ports { RCO }]; #IO_L18N_T2_A11_D27_14 Sch=led[5]
